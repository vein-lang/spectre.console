...
public static partial class AnsiConsole
{
    ...
    /// Writes an exception to the console.
    /// </summary>
    /// <param name="exception">The StackTrace to write to the console.</param>
    /// <param name="format">The exception format options.</param>
    public static void WriteException(StackTrace exception, ExceptionFormats format = ExceptionFormats.Default)
    {
        Console.WriteException(exception, format);
    }
